...
const CHAR_SETS = {
  matrixcode: { path: assetURL('./data/matrixcode_msdf.png'), glyphCount: 56, gridW: 8,  gridH: 8, weights: null },
  matrix1999: {
    path: assetURL('./data/matrix1999_msdf.png'), glyphCount: 64, gridW: 8, gridH: 8,
  ...
  latin:      { path: assetURL('./data/latin_msdf.png'),      glyphCount: 36, gridW: 8,  gridH: 8,  weights: null },
  ascii:      { path: assetURL('./data/ascii_msdf.png'),      glyphCount: 95, gridW: 10, gridH: 10, weights: null },
  // New MTSDF sets — generated by tools/gen-atlas-cli.js
  cyber:      { path: assetURL('./data/cyber_msdf.png'),      glyphCount: 90, gridW: 10, gridH: 10, weights: null },
  cyrillic:   { path: assetURL('./data/cyrillic_msdf.png'),   glyphCount: 76, gridW: 10, gridH: 10, weights: null },
  japanese:   { path: assetURL('./data/japanese_msdf.png'),   glyphCount: 92, gridW: 10, gridH: 10, weights: null },
  chinese:    { path: assetURL('./data/chinese_msdf.png'),    glyphCount: 64, gridW: 8,  gridH: 8,  weights: null },
  orbitron:   { path: assetURL('./data/orbitron_msdf.png'),   glyphCount: 36, gridW: 8,  gridH: 8,  weights: null },
  iosevka:    { path: assetURL('./data/iosevka_msdf.png'),    glyphCount: 95, gridW: 10, gridH: 10, weights: null },
  datatype:   { path: assetURL('./data/datatype_msdf.png'),   glyphCount: 36, gridW: 8,  gridH: 8,  weights: null },
  gsanscode:  { path: assetURL('./data/gsanscode_msdf.png'),  glyphCount: 95, gridW: 10, gridH: 10, weights: null },
};
