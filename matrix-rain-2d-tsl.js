...
const CHAR_SETS = {
  ...
  latin:      { path: '/data/latin_msdf.png',      glyphCount: 36, gridW: 8,  gridH: 8,  weights: null },
  ascii:      { path: '/data/ascii_msdf.png',      glyphCount: 95, gridW: 10, gridH: 10, weights: null },
  // New MTSDF sets — generated by tools/gen-atlas-cli.js
  cyber:      { path: '/data/cyber_msdf.png',      glyphCount: 90, gridW: 10, gridH: 10, weights: null },
  cyrillic:   { path: '/data/cyrillic_msdf.png',   glyphCount: 76, gridW: 10, gridH: 10, weights: null },
  japanese:   { path: '/data/japanese_msdf.png',   glyphCount: 92, gridW: 10, gridH: 10, weights: null },
  chinese:    { path: '/data/chinese_msdf.png',    glyphCount: 64, gridW: 8,  gridH: 8,  weights: null },
  orbitron:   { path: '/data/orbitron_msdf.png',   glyphCount: 36, gridW: 8,  gridH: 8,  weights: null },
  iosevka:    { path: '/data/iosevka_msdf.png',    glyphCount: 95, gridW: 10, gridH: 10, weights: null },
  datatype:   { path: '/data/datatype_msdf.png',   glyphCount: 36, gridW: 8,  gridH: 8,  weights: null },
  gsanscode:  { path: '/data/gsanscode_msdf.png',  glyphCount: 95, gridW: 10, gridH: 10, weights: null },
};
